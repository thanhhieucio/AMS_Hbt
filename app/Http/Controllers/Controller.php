...
/*! \mainpage HSB-IT Code Documentation
 *
 * \section intro_sec Introduction
 *
 * This documentation is designed to allow developers to easily understand
 * the backend code of HSB-IT. Familiarity with the PHP language is assumed,
 ...
 * [Installation documentation](https://docs.hsb.edu.vn/hsb-it) for
 * information on how to install HSB-IT.
 *
 * To learn how to set up a development environment and get started developing for HSB-IT,
 * please see the [contributing documentation](https://docs.hsb.edu.vn/hsb-it/docs/contributing-overview).
 *
 * Only the HSB-IT specific controllers, models, helpers, service providers,
