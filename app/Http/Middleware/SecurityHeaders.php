...
class SecurityHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        // Ugh. Feature-Policy is dumb and clumsy and mostly irrelevant for HSB-IT,
        ...
        // For example, some IT depts have IFRAMED HSB-IT into their IT portal
        ...
        // people who are not running HSB-IT over TLS (shame, shame, shame!)
        // Seriously though, please run HSB-IT over TLS. Let's Encrypt is free.
