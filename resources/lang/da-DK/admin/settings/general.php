...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Hvis en URL er angivet her, vil brugere blive omstillet til den efter de har logget ud af HSB-IT. Det er anvendeligt for at lukke bruger sessions i din authentiseringsmekanisme korrekt.',
    ...
    'show_images_in_email_help' => 'Afkryds denne boks hvis din HSB-IT installation er bag en VPN eller i et lukket netværk og brugere udenfor netværket vil forhinderes i at anvende billeder fra netværket i deres emails.',
    'site_name' => 'Side navn',
    ...
    'support_footer_help' => 'Angiv hvem der kan se links i HSB-IT Support info og brugermanual',
    'version_footer' => 'Version in footer ',
    'version_footer_help' => 'Angiv hvem der kan se HSB-IT versions- og buildnummer.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link til HSB-IT i e-mails',
    'show_url_in_emails_help_text' => 'Fjern markeringen i dette felt, hvis du ikke vil linke tilbage til din HSB-IT-installation i dine e-mail-fodbold. Nyttigt, hvis de fleste af dine brugere aldrig logger ind.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Dette vil forsøge at slette cachede stregkoder. Dette vil typisk kun blive brugt, hvis dine stregkodeindstillinger er ændret, eller hvis din HSB-IT-URL er ændret. Stregkoder vil blive gengenereret når tilgås næste.',
