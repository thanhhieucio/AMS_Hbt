...
return [
    ...
    'ldap_activated_flag_help' => 'តម្លៃនេះត្រូវបានប្រើដើម្បីកំណត់ថា អ្នកប្រើដែលបានធ្វើសមកាលកម្មអាចចូលទៅ HSB-IT បានឬអត់។ <strong>វាមិនប៉ះពាល់ដល់សិទ្ធិពិនិត្យចេញ ឬចូលទ្រព្យសម្បត្តិរបស់ពួកគេទេ</strong> ហើយវាត្រូវជាឈ្មោះ <strong>គុណលក្ខណៈ</strong> នៅក្នុង AD/LDAP របស់អ្នក <strong>មិនមែនតម្លៃ</strong>។
...
<br><br> ប្រសិនបើវាលនេះត្រូវបានកំណត់ទៅឈ្មោះវាលមួយដែលមិនមាននៅក្នុង AD/LDAP របស់អ្នក ឬតម្លៃក្នុងវាល AD/LDAP ត្រូវបានកំណត់ទៅ <code>0</code> ឬ <code>false</code> នោះ<strong>ការចូលរបស់អ្នកប្រើនឹងត្រូវបិទ</strong>។ ប្រសិនបើតម្លៃក្នុងវាល AD/LDAP ត្រូវបានកំណត់ទៅ <code>1</code> ឬ <code>true</code> ឬ <em>អត្ថបទផ្សេងៗ</em> នោះមានន័យថា អ្នកប្រើអាចចូលបាន។ នៅពេលដែលវាលនេះនៅក្នុង AD របស់អ្នកគ្មានតម្លៃ អ្នកប្រើនឹងត្រូវគោរពតាមគុណលក្ខណៈ <code>userAccountControl</code> ដែលជាទម្លាប់អាចអនុញ្ញាតឲ្យអ្នកប្រើដែលមិនបានផ្អាកចូលបាន។',
    ...
    'load_remote_help_text' => 'ដោះធីកប្រអប់នេះ ប្រសិនបើការដំឡើងរបស់អ្នកមិនអាចផ្ទុកស្គ្រីបពីអ៊ីនធឺណិតខាងក្រៅបានទេ។ វានឹងរារាំង HSB-IT ពីការព្យាយាមផ្ទុករូបតំណាងពី Gravatar ឬប្រភពខាងក្រៅផ្សេងទៀត។',
    'login' => 'ការប៉ុនប៉ងចូល',
    ...
    'login_remote_user_custom_logout_url_help' => 'ប្រសិនបើ url ត្រូវបានផ្តល់ជូននៅទីនេះ អ្នកប្រើប្រាស់នឹងត្រូវបានបញ្ជូនបន្តទៅកាន់ URL នេះ បន្ទាប់ពីអ្នកប្រើប្រាស់ចាកចេញពី HSB-IT។ វាមានប្រយោជន៍ក្នុងការបិទវគ្គអ្នកប្រើប្រាស់របស់អ្នកផ្តល់ការផ្ទៀងផ្ទាត់ភាពត្រឹមត្រូវរបស់អ្នក។',
    ...
    'show_images_in_email_help' => 'Uncheck this box if your HSB-IT installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    ...
    'support_footer_help' => 'បញ្ជាក់អ្នកដែលឃើញតំណភ្ជាប់ទៅកាន់ព័ត៌មានជំនួយ HSB-IT និងសៀវភៅណែនាំអ្នកប្រើប្រាស់',
    'version_footer' => 'កំណែនៅក្នុងបាតកថា ',
    'version_footer_help' => 'បញ្ជាក់អ្នកដែលឃើញកំណែ HSB-IT និងលេខសាងសង់។',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'ភ្ជាប់ទៅ HSB-IT នៅក្នុងអ៊ីមែល',
    'show_url_in_emails_help_text' => 'ដោះធីកប្រអប់នេះ ប្រសិនបើអ្នកមិនចង់ភ្ជាប់ទៅការដំឡើង HSB-IT របស់អ្នកនៅក្នុងបាតកថាអ៊ីមែលរបស់អ្នក។ មានប្រយោជន៍ប្រសិនបើអ្នកប្រើភាគច្រើនរបស់អ្នកមិនដែលចូល។ ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'វា​នឹង​ព្យាយាម​លុប​បាកូដ​ដែល​បាន​ទុក​ក្នុង​ឃ្លាំង​សម្ងាត់។ ជាធម្មតា វានឹងត្រូវបានប្រើតែប្រសិនបើការកំណត់បាកូដរបស់អ្នកបានផ្លាស់ប្តូរ ឬប្រសិនបើ URL HSB-IT របស់អ្នកបានផ្លាស់ប្តូរ។ Barcodes នឹង​ត្រូវ​បាន​បង្កើត​ឡើង​វិញ​នៅ​ពេល​ចូល​ប្រើ​បន្ទាប់។',
