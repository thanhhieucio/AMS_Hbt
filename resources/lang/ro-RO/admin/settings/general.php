...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Dacă este furnizată aici o adresă URL, utilizatorii vor fi redirecționați către această adresă URL după ce utilizatorul va ieși din HSB-IT. Acest lucru este util pentru a închide corect sesiunile de utilizator ale furnizorului dvs. de autentificare.',
    ...
    'show_images_in_email_help' => 'Debifați această casetă dacă instalarea dvs. HSB-IT se află în spatele unei rețele VPN sau închisă, iar utilizatorii din afara rețelei nu vor putea încărca imagini din această instalare în e-mailurile lor.',
    'site_name' => 'Nume site',
    ...
    'hsb_version' => 'HSB-IT versiune',
    'support_footer' => 'Legăturile de suport in subsol ',
    'support_footer_help' => 'Specificați cine vede legăturile la informațiile despre asistența HSB-IT și la Manualul utilizatorilor',
    'version_footer' => 'Versiune în subsol ',
    'version_footer_help' => 'Specificați cine vede versiunea HSB-IT și numărul de construcție.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link către HSB-IT în e-mailuri',
    'show_url_in_emails_help_text' => 'Debifați această casetă dacă nu doriți să vă conectați la instalarea dvs. HSB-IT în subsolul dvs. de e-mail. Utile dacă majoritatea utilizatorilor dvs. nu se înregistrează niciodată.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Acest lucru va încerca să șteargă codurile de bare din cache Acest lucru ar fi de obicei utilizat numai în cazul în care setările codului de bare s-au modificat, sau dacă URL-ul HSB-IT s-a schimbat. Codurile de bare vor fi regenerate când sunt accesate ulterior.',
