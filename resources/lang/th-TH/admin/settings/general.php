...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'หากมีการระบุ URL ไว้ที่นี่ผู้ใช้จะได้รับการเปลี่ยนเส้นทางไปยัง URL นี้หลังจากที่ผู้ใช้ล็อกออกจาก HSB-IT ซึ่งจะเป็นประโยชน์ในการปิดเซสชันผู้ใช้ของผู้ให้บริการการรับรองความถูกต้องของคุณอย่างถูกต้อง',
    ...
    'show_images_in_email_help' => 'ยกเลิกการทำเครื่องหมายในช่องนี้หากการติดตั้ง HSB-IT ของคุณอยู่หลัง VPN หรือเครือข่ายที่ปิดอยู่และผู้ใช้ภายนอกเครือข่ายจะไม่สามารถโหลดภาพที่แสดงจากการติดตั้งนี้ในอีเมลของตนได้',
    'site_name' => 'ชื่อไซต์',
    ...
    'support_footer_help' => 'ระบุผู้ที่เห็นลิงก์ไปยังข้อมูลสนับสนุน HSB-IT และคู่มือผู้ใช้',
    'version_footer' => 'รุ่นในส่วนท้าย ',
    'version_footer_help' => 'ระบุผู้ที่สามารถเห็นเวอร์ชัน HSB-IT และบิวด์',
    'system' => 'ข้อมูลระบบ',
    ...
    'width_w' => 'W',
    'height_h' => 'ชั่วโมง',
    'show_url_in_emails' => 'เชื่อมโยงกับ HSB-IT ในอีเมล',
    'show_url_in_emails_help_text' => 'ยกเลิกการเลือกช่องนี้หากคุณไม่ต้องการเชื่อมโยงกับการติดตั้ง HSB-IT ในส่วนท้ายของอีเมล มีประโยชน์หากผู้ใช้ส่วนใหญ่ไม่เคยเข้าสู่ระบบ',
    'text_pt' => 'จุด',
