...
return [
    ...
    'color_settings_help' => 'Diese Einstellungen werden durchweg in HSB-IT verwendet. Benutzer haben die Möglichkeit, die Farbe von Links in ihren Account-Einstellungen individuell anzupassen, um eine optimale Lesbarkeit sicherzustellen.',
    ...
    'link_dark_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die HSB-IT im Dunkel Modus verwenden.',
    'link_light_color' => 'Farbe der Links im Hell Modus',
    'link_light_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die HSB-IT im Hell Modus verwenden.',
    ...
    'ldap_display_name_help' => 'Wenn es ein separates <code>displayName</code> Attribut in Ihrem LDAP/AD gibt, dann können Sie es hier abbilden, womit dieses dann für die Darstellung der Benutzernamen in HSB-IT verwendet wird.',
    ...
    'load_remote_help_text' => 'Deaktivieren Sie dieses Kästchen, wenn Ihre Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass HSB-IT versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus HSB-IT ausloggt. Dies ist nützlich, um die Benutzersitzung Ihres Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help' => 'Deaktivieren Sie dieses Kontrollkästchen, wenn sich Ihre HSB-IT-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihre E-Mails laden können.',
    ...
    'hsb_version' => 'HSB-IT Version',
    'support_footer' => 'Fußzeile Support-Link ',
    'support_footer_help' => 'Geben Sie an, wer die Links zum HSB-IT Support-Info und Benutzerhandbuch sieht',
    'version_footer' => 'Version in in der Fußzeile ',
    'version_footer_help' => 'Spezifiert, wer die Version und Build-Nummer von HSB-IT angezeigt bekommt.',
    ...
    'width_w' => 'b',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link zu HSB-IT in E-Mails',
    'show_url_in_emails_help_text' => 'Deaktivieren Sie dieses Kontrollkästchen, wenn Sie in Ihren E-Mail-Fußzeilen keine Verbindung zu Ihrer HSB-IT-Installation herstellen möchten. Nützlich, wenn die meisten Ihrer Benutzer sich nie einloggen.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Ihre HSB-IT-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'label2_2d_target_help' => 'Die Daten, die im 2D Barcode enthalten sein werden. Dies kann direkt mit dem Gegenstand in HSB-IT verbinden oder einer der nicht verknüpften Feldwerte sein. Wenn Sie das Präfix oben verwenden, wird es diesem Wert vorangestellt.',
    ...
    'help_default_will_use' => 'Beachten Sie, dass der Wert der Barcodes mit der jeweiligen Barcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lesen Sie <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'asset_id' => 'Asset-ID',
    'data' => 'Daten',
    'default' => 'Standard',
    'none' => 'Nichts',
