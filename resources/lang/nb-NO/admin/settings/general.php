...
Linjeskift, topptekst, bilder, osv. kan føre til uventede resultater.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Hvis en URL angis her blir brukerne videresendt til denne URLen etter utlogging fra HSB-IT. Dette er nyttig for korrekt lukking av autentiseringssesjoner hos din autentiseringsleverandør.',
    ...
    'show_images_in_email_help' => 'Fjern merkingen i denne boksen hvis HSB-IT-installasjonen er bak en VPN eller et lukket nettverk og brukere utenfor nettverket ikke vil kunne laste bilder servert fra denne installasjonen i e-posten.',
    ...
    'hsb_version' => 'HSB-IT-versjon',
    'support_footer' => 'Støtte Footer Lenker ',
    'support_footer_help' => 'Angi hvem som kan se lenker til HSB-IT supportinformasjon og brukermanual',
    'version_footer' => 'Versjon i Footer ',
    'version_footer_help' => 'Angi hvem som kan se HSB-IT versjon og build-nummer.',
    ...
    'width_w' => 'b',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link til HSB-IT i e-post',
    'show_url_in_emails_help_text' => 'Fjern markeringen i denne boksen hvis du ikke vil koble tilbake til HSB-IT-installasjonen i e-postboksene dine. Nyttig hvis de fleste av brukerne aldri logger inn.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Dette forsøker å slette hurtigbufrede strekkoder. Dette vil vanligvis bare bli brukt hvis strekkodeinnstillingene dine er endret, eller hvis HSB-IT adressen er endret. Strekkoder genereres på nytt når de blir åpnet neste gang.',
