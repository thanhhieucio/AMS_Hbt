...
return [
    ...
    'login' => 'Είσοδος',
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση HSB-IT χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    ...
    'serial' => 'Σειριακός',
    'hsb_webhook_test' => 'HSB-IT Δοκιμή Ολοκλήρωσης',
    'hsb_webhook_summary' => 'Σύνοψη Δοκιμής Ενσωμάτωσης HSB-IT',
    'supplier' => 'Προμηθευτές',
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για HSB-IT',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της HSB-IT. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας HSB-IT',
