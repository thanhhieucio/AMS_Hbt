...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Εάν παρέχεται ένα url εδώ, οι χρήστες θα ανακατευθυνθούν σε αυτήν τη διεύθυνση URL αφού ο χρήστης αποσυνδεθεί από το HSB-IT. Σε περίπτωση που χρησιμοποιήτε κάποιο συγκεκριμένο πάρωχο Authentication.',
    ...
    'show_images_in_email_help' => 'Απενεργοποιήστε αυτό το πλαίσιο αν η εγκατάσταση HSB-IT βρίσκεται πίσω από ένα VPN ή ένα κλειστό δίκτυο και οι χρήστες έξω από το δίκτυο δεν θα μπορούν να φορτώσουν εικόνες που σερβίρονται από αυτήν την εγκατάσταση στα μηνύματα ηλεκτρονικού ταχυδρομείου τους.',
    ...
    'hsb_version' => 'Hsb-It έκδοση',
    'support_footer' => 'Σύνδεσμοι Υποσέλιδου Υποστήριξης ',
    'support_footer_help' => 'Καθορίστε ποιος βλέπει τους συνδέσμους με τις πληροφορίες υποστήριξης HSB-IT και το εγχειρίδιο χρήσης',
    'version_footer' => 'Έκδοση στο υποσέλιδο ',
    'version_footer_help' => 'Καθορίστε ποιός μπορεί να δει την έκδοση και τον αριθμό κατασκευής του Hsb-ΙΤ.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Σύνδεση με το HSB-IT στα ηλεκτρονικά ταχυδρομεία',
    'show_url_in_emails_help_text' => 'Καταργήστε την επιλογή αυτού του πλαισίου αν δεν θέλετε να συνδεθείτε πίσω στην εγκατάσταση HSB-IT στα υποσέλιδα ηλεκτρονικού ταχυδρομείου σας. Χρήσιμο αν οι περισσότεροι χρήστες σας δεν συνδέονται ποτέ.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Αυτό θα προσπαθήσει να διαγράψει τους προσωρινά αποθηκευμένους barcodes. Αυτό συνήθως θα μπορούσε να χρησιμοποιηθεί μόνο αν οι ρυθμίσεις barcode έχουν αλλάξει, ή αν το URL σας HSB-IT έχει αλλάξει. Οι γραμμωτοί κώδικες θα αναπαραχθούν όταν γίνει πρόσβαση στο επόμενο.',
