...
return [
    ...
    'load_remote_help_text' => 'Vink dit selectievakje uit als uw installatie geen scripts van het internet kan laden. Dit zal voorkomen dat HSB-IT avatars van Gravatar of andere bronnen probeert te laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Als hier een URL wordt opgegeven, worden gebruikers doorgestuurd naar deze URL nadat de gebruiker zich heeft afgemeld bij HSB-IT. Dit is handig om de gebruikerssessies van uw authenticatieprovider correct te sluiten.',
    ...
    'show_images_in_email_help' => 'Schakel dit selectievakje uit als uw HSB-IT-installatie zich achter een VPN of gesloten netwerk bevindt en gebruikers buiten het netwerk geen afbeeldingen vanuit HSB-IT in hun e-mails kunnen laten zien.',
    'site_name' => 'Site naam',
    ...
    'hsb_version' => 'HSB-IT Versie',
    'support_footer' => 'Ondersteuningsvoettekst links ',
    'support_footer_help' => 'Geef aan wie de links naar de HSB-IT-ondersteuningsinformatie en gebruikershandleiding ziet',
    'version_footer' => 'Versie in voettekst ',
    'version_footer_help' => 'Geef aan wie de HSB-IT-versie en het buildnummer ziet.',
    ...
    'width_w' => 'b',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link naar HSB-IT in e-mails',
    'show_url_in_emails_help_text' => 'Schakel dit selectievakje uit als u niet wilt koppelen aan uw HSB-IT-installatie in uw e-mailberichten. Nuttig als de meeste gebruikers nooit inloggen.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Dit probeert de gecachte barcodes te verwijderen. Dit wordt meestal alleen gebruikt als de barcode-instellingen zijn gewijzigd of als de HSB-IT-URL is veranderd. Barcodes worden opnieuw gegenereerd wanneer ze hierna geopend worden.',
