...
return [
    ...
    'portal_welcome_title' => 'Chọn phân hệ bạn muốn sử dụng',
    'portal_welcome_subtitle' => 'Đăng nhập thành công. Vui lòng chọn một phân hệ bên dưới để tiếp tục.',
    'portal_asset_management_desc' => 'Quản lý tài sản, giấy phép phần mềm, phụ kiện và người dùng.',
    'portal_organic_vegetable_desc' => 'Đặt rau hữu cơ theo tuần cho nhân viên và các cơ sở.',
    'portal_coming_soon' => 'Đang phát triển',
    'portal_enter_module' => 'Vào phân hệ',
    'portal_back_link' => 'Quay lại trang chọn phân hệ',
    'portal_coming_soon_title' => 'Phân hệ đang được phát triển',
    'portal_coming_soon_text' => 'Chức năng này đang được xây dựng và sẽ sớm ra mắt. Cảm ơn bạn đã quan tâm.',
    'organic_vegetable_order' => 'Đặt rau hữu cơ',
