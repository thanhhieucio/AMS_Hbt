...
return [
    ...
    'general_help_text' => 'Користувацькі поля зберігають додаткову інформацію, не охоплену стандартними полями активів. <a href="https://docs.hsb.edu.vn/hsb-it/docs/custom-fields#/"><i class="fa fa-external-link"></i></a>.',
];
