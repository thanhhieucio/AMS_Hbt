...
return [
    ...
    'color_settings_help' => 'Ці налаштування будуть використовуватися в усій системі HSB-IT. Користувачі можуть перевизначати кольори посилань у налаштуваннях свого облікового запису відповідно до індивідуальних вимог до читабельності.',
    ...
    'link_dark_color_help' => 'Оберіть колір, що забезпечить достатню контрастність для користувачів, які використовують HSB-IT у темному режимі.',
    'link_light_color' => 'Колір посилань для світлого режиму',
    'link_light_color_help' => 'Оберіть колір, що забезпечить достатню контрастність для користувачів, які використовують HSB-IT у світлому режимі.',
    ...
    'ldap_display_name_help' => 'Якщо у вашому LDAP/AD є окреме поле displayName, вкажіть його тут, і воно буде використовуватися для відображення імен користувачів у HSB-IT.',
    ...
    'load_remote_help_text' => 'Зніміть цей прапорець, якщо інсталяція не може завантажити скрипти з зовнішнього Інтернету. Це не дозволить HSB-IT спробувати завантажити аватари з Gravatar або інших зовнішні джерела.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Якщо вказано посилання, користувачі будуть перенаправлені на цей URL після виходу з HSB-IT. Це корисно для коректного закриття користувацьких сеансів вашого провайдера автентифікації.',
    ...
    'show_images_in_email_help' => 'Зніміть цей прапорець, якщо інсталяція HSB-IT розташована за VPN або закритою мережею, і користувачі за межами мережі не зможуть завантажувати зображення, які обслуговуються з цієї інсталяції у своїх листах.',
    ...
    'hsb_version' => 'Версія HSB-IT',
    'support_footer' => 'Підтримка посилань в футері ',
    'support_footer_help' => 'Вкажіть, хто бачить посилання на інформацію підтримки HSB-IT та посібник користувача',
    'version_footer' => 'Версія в футері ',
    'version_footer_help' => 'Вкажіть, хто бачить версію HSB-IT і номер збірки.',
    ...
    'width_w' => 'т',
    'height_h' => 'г',
    'show_url_in_emails' => 'Посилання на HSB-IT в E-mail-адресах',
    'show_url_in_emails_help_text' => 'Зніміть цей прапорець, якщо ви не хочете вказувати посилання на встановлення HSB-IT у футерах електронної пошти. Корисно, якщо більшість з ваших користувачів ніколи не увійшли. ',
    'text_pt' => 'бал',
    ...
    'barcodes_help' => 'Це спробує видалити кешовані коди. Це зазвичай, буде використано, лише якщо змінилися налаштування штрих-коду або якщо ваша URL-адреса HSB-IT змінилася. Код штрих-кодів буде повторно створено при доступі до наступного.',
    ...
    'label2_2d_target_help' => 'Дані, що міститимуться у 2D-штрихкоді. Це може бути пряме посилання на актив у HSB-IT або значення одного з непов\'язаних полів. Якщо ви використовуєте префікс, вказаний вище, його буде додано на початку до цього значення.',
    ...
    'help_default_will_use' => 'Зверніть увагу: значення штрихкодів мають відповідати специфікаціям відповідного типу штрихкоду для їх успішної генерації. Будь ласка, ознайомтеся з <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">документацією <i class="fa fa-external-link"></i></a> для отримання додаткової інформації.',
    'asset_id' => 'ID Активу',
    'data' => 'Дані',
    'default' => 'Типово',
    'none' => 'Без ефекту',
