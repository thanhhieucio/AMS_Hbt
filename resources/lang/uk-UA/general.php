...
return [
    ...
    'importing_help' => 'The CSV-файл повинен бути розділений комами та відформатований із заголовками, які відповідають тим, що наведені в <a href="https://docs.hsb.edu.vn/hsb-it/docs/importing" target="_new">прикладах CSV у документації <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg' => 'О, клас! Здається, що ваша інтеграція з HSB-IT працює!',
