...
return [
    ...
    'load_remote_help_text' => 'Снимите флажок, если вы не можете загрузить скрипты из интернета. Это предотвратит попытки HSB-IT загрузить аватары из Gravatar или других внешних источников.',
    'login' => 'Попытки входа',
    ...
    'login_remote_user_custom_logout_url_help' => 'Если здесь будет указан URL-адрес, пользователи будут перенаправлены туда после выхода из HSB-IT. Это полезно для правильного закрытия пользовательской сессии вашего поставщика аутентификации.',
    ...
    'show_images_in_email_help' => 'Снимите этот флажок, если ваша установка HSB-IT находится за VPN или в закрытой сети в случае, если в E-mail-ах, которые просматриваются пользователями за пределами указанной сети не отбражаются/не загружаются изображения из данной установки HSB-IT.',
    ...
    'hsb_version' => 'Версия HSB-IT',
    'support_footer' => 'Ссылки на поддержу в нижнем колонтитуле ',
    'support_footer_help' => 'Отображать или не отображать ссылку на руководство пользователя и поддержку HSB-IT',
    'version_footer' => 'Версия в нижнем колонтитуле ',
    'version_footer_help' => 'Отображать или не отображать версию и номер сборки HSB-IT.',
    ...
    'width_w' => 'ширина',
    'height_h' => 'высота',
    'show_url_in_emails' => 'Ссылка на HSB-IT в электронных письмах',
    'show_url_in_emails_help_text' => 'Снимите этот флажок, если вы не хотите ссылаться на свою установку HSB-IT в нижних колонтитулах электронной почты. Полезно, если большинство ваших пользователей никогда не заходят в систему.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Эта операция попытается удалить штрих-коды. Обычно это нужно делать только в том случае, если вы изменили настройки штрих-кода, или изменился URL-адрес вашего инстанса HSB-IT. Штрих-коды будут перегенерированы при следующем запросе.',
