...
return [
    ...
    'login' => 'Логин',
    'login_first_admin' => 'Чтобы войти в Hsb-It используйте следующие логин и пароль:',
    ...
    'hsb_webhook_test' => 'Тест интеграции HSB-IT',
    'hsb_webhook_summary' => 'Резюме теста HSB-IT интеграции',
    'supplier' => 'Поставщик',
    'tag' => 'Метка',
    'test_email' => 'Тестовое сообщение от HSB-IT',
    'test_mail_text' => 'Это тестовое сообщение от HSB-IT. Если вы его получили, значит почта работает :)',
    ...
    'your_credentials' => 'Ваш логин и пароль от HSB-IT',
