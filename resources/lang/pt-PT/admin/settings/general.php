...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Se preenchido, os utilizadores serão redirecionados para este URL depois de fecharem a sessão no HSBIT. É particularmente útil para fechar corretamente a sessão do utilizador do fornecedor de autenticação.',
    ...
    'show_images_in_email_help' => 'Desmarque esta caixa se a sua instalação do HSB-IT estiver a correr através de uma VPN ou rede fechada e utilizadores fora da rede não conseguirem carregar as imagens desta instalação nos seus e-mails.',
    ...
    'hsb_version' => 'Versão HSB-IT',
    'support_footer' => 'Links de rodapé de suporte',
    'support_footer_help' => 'Especifica quem vê os links de Suporte e Manual de utilizador do HSB-IT',
    ...
    'barcodes_help' => 'Isto irá apagar códigos de barras em cache. Isto normalmente só deveria ser usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do HSB-IT tivesse sido alterada. Códigos de barras serão novamente gerados quando forem acedidos.',
