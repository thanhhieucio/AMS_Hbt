...
return [
    ...
    'api_reference' => 'Verifique a referência <a href="https://docs.hsb.edu.vn/hsb-it/reference" target="_blank">da API</a> para encontrar endpoints de API específicos e documentação adicional da API.',
