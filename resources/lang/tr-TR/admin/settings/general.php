...
return [
    ...
    'color_settings_help' => 'Bu ayarlar HSB-IT genelinde kullanılacaktır. Kullanıcılar, kendi okunabilirlik gereksinimlerini karşılamak amacıyla hesap tercihlerini düzenleyerek bağlantı renklerini geçersiz kılabilirler.',
    ...
    'link_dark_color_help' => 'HSB-IT’i karanlık modda kullanan kişiler için yeterli kontrast sağlayacak bir renk seçin.',
    'link_light_color' => 'Aydınlık Mod için Bağlantı Rengi',
    'link_light_color_help' => 'HSB-IT’i aydınlık modda kullanan kişiler için yeterli kontrast sağlayacak bir renk seçin.',
    ...
    'ldap_display_name_help' => 'LDAP/AD’nizde ayrı bir displayName alanı varsa, buraya eşleyin; HSB-IT içinde kullanıcıları görüntülerken bu alan kullanılacaktır.',
    ...
    'ldap_activated_flag_help' => 'Bu değer, senkronize edilmiş bir kullanıcının HSB-IT\'de oturum açıp açamayacağını belirlemek için kullanılır. Girdiğiniz değer AD/LDAP tarafındaki Attribute ismi ile aynı olmamalı. Bu alana girdiğiniz değer AD/LDAP üzerinde yok ise veya değeri 0 ise kullanıcı girişi devre dışı kalacaktır. Eğer Attribute değeri 1, true yada başka bir metin ise kullanıcı girişine izin verilecektir. Eğer Attribute değeri boş bırakılmış ve kullanıcı askıya alınmamış ise userAccountControl ayarı esas alınacaktır.',
    ...
    'load_remote_help_text' => 'Yükleme dış internetten komut dosyalarını yükleyemiyorsa bu kutunun işaretini kaldırın. Bu, HSB-IT\'nin Gravatar veya diğer dış kaynaklardan avatarları yüklemeye çalışmasını engeller.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Burada bir URL verilirse, kullanıcı HSB-IT oturumunu kapattıktan sonra kullanıcılar bu URL\'ye yönlendirilir. Bu, Kimlik Doğrulama sağlayıcınızın kullanıcı oturumlarını doğru bir şekilde kapatmak için kullanışlıdır.',
    ...
    'show_images_in_email_help' => 'HSB-IT kurulumunuz bir VPN\'in ya da kapalı bir ağın arkasındaysa ve ağ dışındaki kullanıcılar bu kurulumda sunulan görüntüleri e-postalarına yükleyemezse bu kutunun işaretini kaldırın.',
    'site_name' => 'Site Adı',
...
<a href=":webhook_link" target="_new" rel="noopener">gelen bir webhook oluştur</a>:app hesabınızda. Tıkla<strong>Test :app Entegrasyonu</strong>Kaydetmeden önce ayarlarınızın doğru olduğunu onaylamak için düğmesine basın. ',
    ...
    'support_footer_help' => 'HSB-IT destek, bilgi ve Kullanıcı Kılavuzu linklerini kimin göreceğini seçin',
    'version_footer' => 'Altbilgi içinde Sürüm ',
    'version_footer_help' => 'HSB-IT sürümünü kimin göreceğini ve yapı numarasını belirleyin.',
    ...
    'width_w' => 'g',
    'height_h' => 'y',
    'show_url_in_emails' => 'E-postalardaki HSB-IT\'ye bağlantı',
    'show_url_in_emails_help_text' => 'E-posta altbilgilerinizdeki HSB-IT kurulumuna geri dönmek istemiyorsanız, bu kutuyu kaldırın. Kullanıcılarınızın çoğu hiç giriş yapmazsa kullanışlıdır.',
    'text_pt' => 'dpi',
    ...
    'barcodes_help' => 'Bu, önbelleğe alınmış barkodları silmeyi dener. Bu, genellikle yalnızca barkod ayarlarınız değiştiyse veya HSB-IT URL\'niz değiştiyse kullanılır. Bir sonraki erişimde barkodlar yeniden oluşturulacaktır.',
    ...
    'label2_2d_target_help' => '2D barkod içinde yer alacak veridir. Bu, doğrudan HSB-IT’teki varlığa bağlantı verebilir veya bağlantısız alan değerlerinden biri olabilir. Yukarıdaki ön eki kullanırsanız, bu değerin başına eklenecektir.',
    ...
    'help_default_will_use' => 'Barkod değerlerinin başarılı bir şekilde oluşturulabilmesi için ilgili barkod standardına uygun olması gerektiğini unutmayın. Daha fazla bilgi için <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">dokümantasyona <i class="fa fa-external-link"></i></a> bakın ',
    'asset_id' => 'Varlık ID',
    'data' => 'Veri',
    'default' => 'Varsayılan',
    'none' => 'Hiçbiri',
