...
return [
    ...
    'load_remote_help_text' => 'Décochez cette case si votre installation ne peut pas charger de scripts depuis internet. Cela empêchera HSB-IT de tenter de charger les avatars depuis Gravatar ou toute autre source externe.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de HSB-IT. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'authentification.',
    ...
    'show_images_in_email_help' => 'Décocher cette case si votre installation de HSB-IT est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs courriels.',
    ...
    'hsb_version' => 'Version de HSB-IT',
    'support_footer' => 'Support des liens de pied de page ',
    'support_footer_help' => 'Spécifiez qui voit les liens vers les manuels de support utilisateur HSB-IT',
    'version_footer' => 'Version en pied de page ',
    'version_footer_help' => 'Spécifiez qui peut voir la version de HSB-IT.',
    ...
    'width_w' => 'l',
    'height_h' => 'h',
    'show_url_in_emails' => 'Lien vers HSB-IT dans les e-mails',
    'show_url_in_emails_help_text' => 'Décochez cette case si vous ne souhaitez pas relier votre installation HSB-IT à vos pieds de page. Utile si la plupart de vos utilisateurs ne se connectent jamais.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Cette opération essaiera de supprimer l\'ensemble des code-barres mis en cache. Cette opération n\'est utile que si les réglages de génération de code-barre ont été changés, ou si l\'URL de votre instance HSB-IT a été modifiée. Les code-barres seront regénérés au prochain accès.',
