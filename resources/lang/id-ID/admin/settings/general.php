...
return [
    ...
    'load_remote_help_text' => 'Hapus centang kotak ini jika instalasi Anda tidak dapat memuat skrip dari internet eksternal. Ini akan mencegah HSB-IT mencoba memuat avatar dari Gravatar atau sumber eksternal lainnya.',
    ...
    'show_images_in_email_help' => 'Hapus centang kotak ini jika instalasi HSB-IT Anda berada di belakang VPN atau jaringan tertutup dan pengguna di luar jaringan tidak akan dapat memuat gambar yang disajikan dari instalasi ini di email mereka.',
    ...
    'hsb_version' => 'Versi HSB-IT',
    'support_footer' => 'Mendukung Footer Links ',
    'support_footer_help' => 'Tentukan siapa yang melihat tautan ke info Dukungan HSB-IT dan Panduan Pengguna',
    'version_footer' => 'Versi pada Footer ',
    'version_footer_help' => 'Tentukan siapa saja yang dapat melihat versi dan build number dari HSB-IT.',
    ...
    'width_w' => 'l',
    'height_h' => 't',
    'show_url_in_emails' => 'Tautan ke HSB-IT di Email',
    'show_url_in_emails_help_text' => 'Hapus centang pada kotak ini jika Anda tidak ingin menautkan kembali ke instalasi HSB-IT Anda di footer email Anda. Berguna jika sebagian besar pengguna Anda tidak pernah masuk.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Ini akan mencoba menghapus barcode yang di-cache. Ini biasanya hanya digunakan jika pengaturan barcode Anda telah berubah, atau jika URL HSB-IT Anda telah berubah. Barcode akan dibuat ulang saat diakses berikutnya.',
