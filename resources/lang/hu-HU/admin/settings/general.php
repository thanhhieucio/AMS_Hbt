...
return [
    ...
    'ldap_display_name_help' => 'Ha van külön displayName mező az LDAP/AD rendszeredben, térképezd ide, és azt fogja használni a HSB-IT a felhasználók megjelenítéséhez.',
    ...
    'load_remote_help_text' => 'Vedd ki a pipát ebből a négyzetből, ha a telepítésed nem tud külső internetes forrásokból szkripteket betölteni. Ez megakadályozza, hogy a HSB-IT megpróbálja az avatarokat a Gravatarról vagy más külső forrásokból betölteni.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ha megad itt egy URL-t, a felhasználók a HSB-IT-ből való kilépéskor át lesznek irányítva a megadott URL-re. Ez hasznos lehet a hitelesítés szolgáltatónál meglévő felhasználói munkamenet megfelelő lezárására.',
    ...
    'show_images_in_email_help' => 'Vegye ki a jelölést innen, ha az Ön HSB-IT alkalmazása VPN mögött, vagy zárt hálózaton található, és a felhasználók a hálózaton kívül nem tudják az emailekben megjeleníteni az alkalmazás által szolgáltatott képeket.',
    ...
    'hsb_version' => 'HSB-IT változat',
    'support_footer' => 'Lábjegyzet linkek támogatása ',
    'support_footer_help' => 'Adja meg, hogy ki láthassa a HSB-IT támogatási információ és a felhasználói kézikönyv linkjeit',
    'version_footer' => 'Verzió a láblécben ',
    'version_footer_help' => 'Határozza meg, hogy ki láthassa a HSB-IT verzió és build adatokat.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link a HSB-IT-re az e-mailekben',
    'show_url_in_emails_help_text' => 'Törölje a jelet a jelölőnégyzetből, ha nem kíván visszaváltani a HSB-IT telepítéséhez az e-mail láblécében. Hasznos ha a legtöbb felhasználó soha nem jelentkezik be.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Ez megpróbálja törölni a gyorsítótárazott vonalkódokat. Ezt általában csak akkor használja, ha a vonalkód beállításai megváltoztak, vagy ha a HSB-IT URL címe megváltozott. A vonalkódok a következő eléréskor újra generálásra kerülnek.',
