...
return [
    ...
    'color_settings_help' => 'Queste impostazioni saranno utilizzate in tutto HSB-IT. Gli utenti possono modificare i colori dei link modificando le preferenze del proprio account per soddisfare le proprie esigenze di leggibilità.',
    ...
    'link_dark_color_help' => 'Seleziona un colore che fornisca un contrasto sufficiente per le persone che utilizzano HSB-IT in modalità scura.',
    'link_light_color' => 'Colore del link per la modalità chiara',
    'link_light_color_help' => 'Seleziona un colore che fornisca un contrasto sufficiente per le persone che utilizzano HSB-IT in modalità chiara.',
    ...
    'ldap_display_name_help' => 'Se hai un campo displayName separato nel tuo LDAP/AD, mappa qui e verrà utilizzato per mostrare gli utenti in HSB-IT.',
    ...
    'load_remote_help_text' => 'Deseleziona questa casella se la tua installazione non può caricare gli script dall\'esterno. Questo impedirà a HSB-IT di provare il caricamento degli avatar da Gravatar o da altre fonti esterne.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzato a questo URL dopo essere usciti da HSB-IT. Questo è utile per chiudere correttamente le sessioni dell\'utente.',
    ...
    'show_images_in_email_help' => 'Deseleziona questa casella se l\'installazione di HSB-IT si trova dietro una rete VPN o chiusa e gli utenti esterni alla rete non saranno in grado di caricare le immagini fornite da questa installazione nelle loro e-mail.',
    'site_name' => 'Nome sito',
    ...
    'support_footer_help' => 'Specificare chi vede i collegamenti alle informazioni sul supporto IT e su HSB-IT',
    'version_footer' => 'Versione a piè di pagina ',
    'version_footer_help' => 'Specifica chi può vedere la versione di HSB-IT e il numero di build.',
    ...
    'width_w' => 'l',
    'height_h' => 'h',
    'show_url_in_emails' => 'Collegamento a HSB-IT in posta elettronica',
    'show_url_in_emails_help_text' => 'Deseleziona questa casella se non si desidera collegare nuovamente all\'installazione HSB-IT nei piè di pagina di posta elettronica. Utile se la maggior parte dei tuoi utenti non entra mai in login.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Ciò eliminerà i codici a barre nella cache, utilizzato di solito se le impostazioni dei codici a barre sono cambiate, o se l\'URL di HSB-IT è cambiato. I codici a barre saranno ri-generati alla prossima richiesta.',
    ...
    'label2_2d_target_help' => 'Dato che saranno contenuti nel codice a barre 2D. Può collegarti direttamente al Bene in HSB-IT, o può essere uno dei valori di campo non collegati. Se usi il prefisso qui sopra, sarà anteposto a questo valore.',
    ...
    'help_default_will_use' => 'Si noti che il valore dei codici a barre deve essere conforme al rispettivo codice a barre per essere generato con successo. Si prega di vedere <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">la documentazione <i class="fa fa-external-link"></i></a> per maggiori dettagli. ',
    'asset_id' => 'ID Bene',
    'data' => 'Dati',
    'default' => 'Predefinito',
    'none' => 'Niente',
