...
return [
    ...
    'load_remote_help_text' => 'Počistite to polje, če vaša namestitev ne more naložiti skriptov iz zunanjega interneta. To bo preprečilo, da bi HSB-IT poskušal naložiti avatarje iz Gravatarja ali drugih zunanjih virov.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Če je tukaj naveden URL, bodo uporabniki po odjavi iz HSB-IT preusmerjeni na ta URL. To je uporabno za pravilno zapiranje uporabniških sej vašega ponudnika preverjanja pristnosti.',
    ...
    'show_images_in_email_help' => 'Počistite to polje, če je vaša namestitev HSB-IT za VPN-jem ali zaprtim omrežjem in uporabniki zunaj omrežja ne bodo mogli naložiti slik, poslanih iz te namestitve, v svoja e-poštna sporočila.',
    'site_name' => 'Ime mesta',
    ...
    'hsb_version' => 'HSB-IT različica',
    'support_footer' => 'Povezava do podpore v nogi ',
    'support_footer_help' => 'Določite, kdo vidi povezave do informacij o podpori HSB-IT in uporabniškega priročnika',
    'version_footer' => 'Verzija v nogi ',
    'version_footer_help' => 'Določite, kdo vidi različico in številko gradnje HSB-IT.',
    ...
    'width_w' => 'š',
    'height_h' => 'v',
    'show_url_in_emails' => 'Povezava na HSB-IT v e-poštnih sporočilih',
    'show_url_in_emails_help_text' => 'Počistite polje, če se ne želite povezati z namestitvijo HSB-IT v njenih e-poštnih podnožjih. Uporabno, če se večina uporabnikov nikoli ne prijavlja. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'To bo poskušalo izbrisati predpomnjene črtne kode. To se običajno uporabi le, če so se vaše nastavitve črtnih kod spremenile ali če se je spremenil vaš URL HSB-IT. Črtne kode bodo ponovno ustvarjene ob naslednjem dostopu.',
