...
return [
    ...
    'color_settings_help' => 'Estos ajustes se utilizarán a través de HSB-IT. Los usuarios pueden anular los colores de los enlaces editando sus preferencias de cuenta para cumplir con sus requisitos individuales de legibilidad.',
    ...
    'link_dark_color_help' => 'Seleccione un color que proporcionará suficiente contraste para las personas que usan HSB-IT en modo oscuro.',
    'link_light_color' => 'Color de enlace para modo Claro',
    'link_light_color_help' => 'Selecciona un color que proporcione suficiente contraste para las personas que utilicen HSB-IT en modo Claro.',
    ...
    'ldap_display_name_help' => 'Si tiene un campo displayName separado en su LDAP/AD, lo mapeará aquí y se utilizará para mostrar usuarios dentro de HSB-IT.',
    ...
    'load_remote_help_text' => 'Desmarque esta casilla si su instalación no puede cargar secuencias de comandos (scripts) desde Internet . Esto evitará que HSB-IT intente cargar avatares de Gravatar u otras fuentes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una URL aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de HSB-IT. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help' => 'Desmarque esta casilla si su instalación de HSB-IT está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes publicadas desde este servidor de HSB-IT en sus correos electrónicos.',
    ...
    'hsb_version' => 'Versión de HSB-IT',
    'support_footer' => 'Enlace al soporte en el pie de página ',
    'support_footer_help' => 'Especifique quién puede ver los enlaces a la información de soporte de HSB-IT y al manual de usuario.',
    'version_footer' => 'Versión en el pie de página ',
    'version_footer_help' => 'Especifique quién puede ver la versión de HSB-IT y el número de compilación.',
    ...
    'width_w' => 'ancho',
    'height_h' => 'alto',
    'show_url_in_emails' => 'Enlace a HSB-IT en correos electrónicos',
    'show_url_in_emails_help_text' => 'Desmarque esta casilla si no desea vincular su instalación de HSB-IT en el pie de página de correo electrónico. Útil si la mayoría de sus usuarios nunca se conectan. ',
    'text_pt' => 'puntos',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras almacenados en caché. Normalmente solo se usa si la configuración del código de barras ha cambiado o si ha cambiado la URL de HSB-IT. Los códigos de barras se volverán a generar la próxima vez que se acceda a ellos.',
