...
return [
    ...
    'login' => 'الدخول',
    'login_first_admin' => 'قم بتسجيل الدخول إلى التثبيت الجديد من HSB-IT باستخدام البيانات أدناه:',
    ...
    'hsb_webhook_test' => 'اختبار تكامل القنص',
    'hsb_webhook_summary' => 'ملخص اختبار تكامل القناصة',
    'supplier' => 'المورد',
    'tag' => 'الترميز',
    'test_email' => 'اختبار البريد الإلكتروني من قنص-تكنولوجيا المعلومات',
    'test_mail_text' => 'يعتبر هذا اختبارا من نظام إدارة الأصول HSB-IT. إذا كنت حصلت على هذا، فان البريد يعمل :)',
