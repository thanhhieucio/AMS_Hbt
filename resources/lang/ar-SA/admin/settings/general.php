...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'إذا تم توفير عنوان URL هنا، سيتم إعادة توجيه المستخدمين إلى عنوان URL هذا بعد تسجيل خروج المستخدم من HSB-IT. هذا مفيد لإغلاق جلسات عمل المستخدم لموفر المصادقة بشكل صحيح.',
    ...
    'show_images_in_email_help' => 'قم بإلغاء تحديد هذا المربع إذا كان تثبيت HSB-IT وراء شبكة VPN أو شبكة مغلقة ولن يتمكن المستخدمون خارج الشبكة من تحميل الصور التي يخدمها هذا التثبيت في رسائل البريد الإلكتروني الخاصة بهم.',
    ...
    'version_footer_help' => 'حدد من سوف يرى إصدار HSB-IT و رقم النسخة.',
    ...
    'width_w' => 'ث',
    'height_h' => 'ح',
    'show_url_in_emails' => 'الرابط إلى HSB-IT في رسائل البريد الإلكتروني',
    'show_url_in_emails_help_text' => 'قم بإلغاء اختيار هذا المربع إذا كنت لا ترغب في الربط مرة أخرى إلى HSB-IT في تذييل البريد الإلكتروني الخاص بك. تعد مفيدة إذا كان معظم المستخدمين لا يقومون بتسجيل الدخول. ',
    'text_pt' => 'حزب العمال',
    ...
    'barcodes_help' => 'هذا سيحاول حذف رموز الباركود المخزنة مؤقتاً. سيتم استخدام هذا عادة فقط إذا تغيرت إعدادات الباركود الخاص بك، أو إذا تغير رابط HSB-IT الخاص بك. سيتم إعادة إنشاء الرموز الشريطية عند الوصول إليها بعد ذلك.',
