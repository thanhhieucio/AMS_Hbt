...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako je ovdje upisan url, korisnici će biti biti preusmjereni na taj URL nakon što se odjave iz HSB-IT-a. Ovo je korisno radi ispravnog zatvaranja korisničkog session-a kod vašeg pružatelja autentifikacije.',
    ...
    'show_images_in_email_help' => 'Isključite ovaj okvir ako je vaša HSB-IT instalacija iza VPN ili zatvorene mreže, a korisnici izvan mreže neće moći učitati slike poslužene s ove instalacije u njihovu e-poštu.',
    ...
    'support_footer_help' => 'Navedite tko vidi poveznice na informacije o HSB-IT podršci i korisničkom priručniku',
    'version_footer' => 'Verzija u podnožju ',
    'version_footer_help' => 'Odredite tko može vidjeti HSB-IT verziju i build broj.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Veza na HSB-IT u e-pošti',
    'show_url_in_emails_help_text' => 'Poništite potvrdni okvir ako ne želite povezati vašu HSB-IT instalaciju u svoje podnožje e-pošte. Korisno je ako se većina korisnika nikada ne prijavljuje.',
    'text_pt' => 'PT',
