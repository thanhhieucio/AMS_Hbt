...
return [
    ...
    'importing_help' => 'CSV файла трябва да бъде разделен със запетая и форматиран със заглавия на колоните като тези показани в <a href="https://docs.hsb.edu.vn/hsb-it/docs/importing" target="_new">примерната CSVs документация <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg' => 'Интеграцията на вашето :app пролежение работи с HSB-IT!',
