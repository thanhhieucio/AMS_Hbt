...
return [
    ...
    'info' => 'Статус етикетите се използват за описание на различните състояния на активите. Може да създадете нови видове статус етикети за вашите активи, например изгубени, откраднати, предадени за ремонт и други. За повече информация: <a href="https://docs.hsb.edu.vn/hsb-it/docs/overview#status-labels" target="_blank">линк към документацията <i class="fa fa-external-link"></i></a>.',
    'name' => 'Статус',
    'pending' => 'Изчакване',
