...
return [
    ...
    'color_settings_help' => 'Тези настройки ще бъдат използвани в HSB-IT. Потребителите ще могат да изберат свой собствени настройки на цвета на връзките от техните настройки през акаунта.',
    ...
    'link_dark_color_help' => 'Изберете цвят, който има достатъчно контраст за хората, който ползват HSB-IT в тъмен режим.',
    'link_light_color' => 'Цвят на връзките за светъл режим',
    'link_light_color_help' => 'Изберете цвят, който има достатъчно контраст за хората, който ползват HSB-IT в светъл режим.',
    ...
    'ldap_display_name_help' => 'Ако имате отделно displayName поле във вашия LDAP/AD, свържете го тук и то ще бъде име за покзване в HSB-IT.',
    ...
    'load_remote_help_text' => 'Премахнете отметката от това квадратче, ако вашата инсталация не може да зареди скриптове от външен интернет. Това ще попречи на HSB-IT да се опита да зареди аватари от Gravatar или други външни източници.',
    'login' => 'Опити за вход',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от HSB-IT. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'hsb_version' => 'HSB-IT версия',
    'support_footer' => 'Връзки към Hsb-it поддръжката във футъра',
    'support_footer_help' => 'Указва визуализацията на връзки към поддръжката на HSB-IT и потребителската документация',
    'version_footer' => 'Версия в долен колонтитул ',
    'version_footer_help' => 'Определя кой ще вижда HSB-IT версията и номера на компилация.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Връзка към HSB-IT в имейли',
    'show_url_in_emails_help_text' => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата HSB-IT инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Това ще изтрие кеша на баркодовете. Това обикновено се използва при промяна на баркод настройките или при промяна на HSB-IT URL адреса. Баркодовете ще бъдат генерирани отново.',
    ...
    'label2_2d_target_help' => 'Тази информация ще бъде добавена в 2D баркод. Това може да е връзка към актив директно в HSB-IT или към поле което не е свързано със стойност. Ако използвате този префикс отгоре, той ще бъде добавен към тази стойност.',
    ...
    'help_default_will_use' => 'Стойността на баркода трябва да отговаря на изискванията за баркод или той няма да се генерира. Моля вижте следната <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">документация<i class="fa fa-external-link"></i></a> за повече информация. ',
    'asset_id' => 'Актив ID',
    'data' => 'Данни',
