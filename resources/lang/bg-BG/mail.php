...
return [
    ...
    'login' => 'Логин',
    'login_first_admin' => 'Влезте в своята HSB-IT инсталация използвайки данните по-долу:',
    ...
    'hsb_webhook_test' => 'HSB-IT Интеграционен тест',
    'hsb_webhook_summary' => 'HSB-IT Резюме на интеграционния тест',
    'supplier' => 'Доставчик',
    'tag' => 'Етикет',
    'test_email' => 'Тест Email от HSB-IT',
    'test_mail_text' => 'Това е тест от HSB-IT система за управление на активи. Ако сте получили това, email-а работи :)',
    ...
    'your_credentials' => 'Вашите идентификационни данни за HSB-IT',
