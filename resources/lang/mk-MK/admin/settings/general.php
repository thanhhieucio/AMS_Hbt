...
return [
    ...
    'load_remote_help_text' => 'Отштиклирајте го ова поле ако вашата инсталација не може да ги вчита скриптите од надворешниот Интернет. Ова ќе го спречи Hsb-It да проба да вчита аватари од Gravatar или други надворешни извори.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако тука е обезбедена URL адреса, корисниците ќе се пренасочат на оваа URL-адреса откако корисникот ќе се одјави од Hsb-It. Ова е корисно за правилно да ги затворите корисничките сесии на вашиот провајдер за автентикација.',
    ...
    'show_images_in_email_help' => 'Отштиклирајте ја оваа кутија ако вашата инсталација на Hsb-It е зад а VPN или затворена мрежа и корисници надвор од мрежата нема да можат да вчитаат слики што се служат од оваа инсталација во нивната е-пошта.',
    ...
    'hsb_version' => 'HSB-IT верзија',
    'support_footer' => 'Поддржете ги врските во подножјето ',
    'support_footer_help' => 'Наведете кој ги гледа врските до HSB-IT Информации за поддршка и прирачник за корисници',
    'version_footer' => 'Верзија во подножјето ',
    'version_footer_help' => 'Наведете кој гледа HSB-IT верзија.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Врска до Hsb-It во е-пошта',
    'show_url_in_emails_help_text' => 'Отштиклирајте го ова поле ако не сакате да се поврзете со инсталацијата на Hsb-It во вашите подножје за е-пошта. Корисно ако повеќето од вашите корисници никогаш не се најавуваат. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Ова ќе се обиде да ги избрише зачуваните баркодови.Ова обично се користи само ако вашите поставки за баркод се променети, или ако URL-то на Hsb-It се смени. Баркодовите ќе бидат повторно генерирани кога ќе се пристапи до следното..',
