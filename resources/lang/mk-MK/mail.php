...
return [
    ...
    'login' => 'Најава',
    'login_first_admin' => 'Влезете во новата инсталација на HSB-IT користејќи ги ингеренциите подолу:',
    ...
    'serial' => 'Сериски',
    'hsb_webhook_test' => 'HSB-IT Тест за интеграција',
    'hsb_webhook_summary' => 'HSB-IT Резиме на тест за интеграција',
    'supplier' => 'Добавувач',
    'tag' => 'Таг',
    'test_email' => 'Тест е-пошта од HSB-IT',
    'test_mail_text' => 'Ова е тест од HSB-IT Системот за управување со основни средства. Ако го добивте ова, е-поштата работи :)',
