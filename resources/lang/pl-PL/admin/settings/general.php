...
return [
    ...
    'load_remote_help_text' => 'Odznacz to pole, jeśli instalacja nie może załadować skryptów z zewnętrznego internetu. To uniemożliwi HSB-IT próby załadowania obrazów z Gravatar.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jeżeli URL jest tutaj wpisany, użytkownicy zostaną przekierowani do tego adresu URL po wylogowaniu ze HSB-IT. Jest to przydatne do prawidłowego zamknięcia sesji użytkownika twojego dostawcy uwierzytelniania.',
    ...
    'show_images_in_email_help' => 'Odznacz to pole, jeśli twoja instalacja HSB-IT znajduje się za siecią VPN lub siecią zamkniętą, a użytkownicy spoza sieci nie będą mogli załadować obrazów obsługiwanych przez tę instalację w swoich wiadomościach e-mail.',
    ...
    'hsb_version' => 'Wersja HSB-IT',
    'support_footer' => 'Obsługa linków stopki ',
    'support_footer_help' => 'Określ kto widzi linki do HSB-IT Instrukcji Obsługi oraz Wsparcia',
    'version_footer' => 'Wersja w stopce ',
    'version_footer_help' => 'Określ, kto widzi wersję oraz numer kompilacji HSB-IT.',
    ...
    'width_w' => 'szerokość',
    'height_h' => 'wysokość',
    'show_url_in_emails' => 'Połącz się z HSB-IT w wiadomościach e-mail',
    'show_url_in_emails_help_text' => 'Usuń zaznaczenie tego pola, jeśli nie chcesz łączyć się z instalacją HSB-IT w stopkach wiadomości e-mail. Przydatne, jeśli większość użytkowników nigdy nie loguje się.',
    'text_pt' => 'piksel',
    ...
    'barcodes_help' => 'Spowoduje to próbę usunięcia kodów kreskowych z pamięci podręcznej. Jest to zwykle używane tylko wtedy, gdy zmieniły się ustawienia kodu kreskowego lub jeśli zmienił się adres URL HSB-IT. Kody kreskowe zostaną wygenerowane ponownie przy następnym dostępie.',
