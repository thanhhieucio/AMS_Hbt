...
return [
 ...
 eles não serão visíveis para você novamente.',
    ...
    'api_reference' => 'Por favor, verifique as <a href="https://docs.hsb.edu.vn/hsb-it/reference" target="_blank"> referências da API</a> para encontrar endpoints específicos da API e documentação adicional da API.',
