...
return [
    ...
    'info' => 'Os tipos de rótulos de situação são usados ​​para descrever os vários estados em que seus ativos podem se encontrar. Eles podem estar em reparo, perdidos/roubados, etc. Você pode criar novos rótulos de situação para seus ativos implantáveis, pendentes e arquivados de acordo com seu próprio fluxo de trabalho. Para mais informações, <a href="https://docs.hsb.edu.vn/hsb-it/docs/overview#status-labels" target="_blank"> consulte a documentação <i class="fa fa-external-link"></i></a>.',
