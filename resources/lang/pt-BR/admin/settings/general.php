...
return [
    ...
    'load_remote_help_text' => 'Desmarque essa caixa se a sua instalação não pode carregar scripts vindos da internet. Isso vai prevenir que o HSB-IT carregue avatares do Gravatar ou outras fontes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do HSB-IT. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    ...
    'show_images_in_email_help' => 'Desmarque esta caixa se sua instalação de HSB-IT está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'hsb_version' => 'Versão do HSB-IT',
    'support_footer' => 'Links de rodapé de suporte ',
    'support_footer_help' => 'Especifique quem vê os links para as informações de Suporte HSB-IT e o Manual do Usuário',
    'version_footer' => 'Versão no Rodapé ',
    'version_footer_help' => 'Especifica quem vê o número de versão e compilação do Hsb-lT.',
    ...
    'width_w' => 'largura',
    'height_h' => 'altura',
    'show_url_in_emails' => 'Link para HSB-IT em E-mails',
    'show_url_in_emails_help_text' => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação HSB-IT em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Isto tentará apagar códigos de barras em cache. Isso normalmente só seria usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do HSB-IT tivesse sido alterada. Códigos de barras serão re-gerados quando acessados em seguida.',
