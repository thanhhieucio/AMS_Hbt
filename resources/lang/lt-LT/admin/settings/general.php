...
return [
    ...
    'color_settings_help' => 'Šie nustatymai bus naudojami visoje HSB-IT sistemoje. Naudotojai gali pakeisti nuorodų spalvas, redaguodami savo paskyros nuostatas, kad jos atitiktų individualius skaitomumo reikalavimus.',
    ...
    'link_dark_color_help' => 'Pasirinkite spalvą, kuri užtikrins pakankamą kontrastą žmonėms, naudojantiems „HSB-IT“ tamsiu režimu.',
    'link_light_color' => 'Susieti spalvą su šviesiu režimu',
    'link_light_color_help' => 'Pasirinkite spalvą, kuri užtikrins pakankamą kontrastą žmonėms, naudojantiems „HSB-IT“ šviesiu režimu.',
    ...
    'ldap_display_name_help' => 'Jei jūsų LDAP/AD paskyroje yra atskiras „displayName“ laukas, susiekite jį čia ir jis bus naudojamas naudotojų rodymui „HSB-IT“.',
    ...
    'load_remote_help_text' => 'Atžymėkite šį langelį, jei jūsų diegimas negali vykdyti skriptų iš interneto. Tai neleis „HSB-IT“ bandyti įkelti avatarų iš „Gravatar“ ar kitų išorinių šaltinių.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jei čia yra pateiktas adresas, į jį bus nukreipti naudotojai po to, kai atsijungs nuo „HSB-IT“. Tai naudinga norint tinkamai uždaryti autentifikuotų naudotojų sesijas.',
    ...
    'show_images_in_email_help' => 'Nuimkite žymelę jeigu jūsų HSB-IT diegimas yra už VPN arba uždarame tinkle, kitaip tinkle nesantys išorės naudotojai negalės matyti el. laiškuose pateiktų atvaizdų.',
    ...
    'hsb_version' => 'HSB-IT versija',
    'support_footer' => 'Palaikymo nuorodos poraštėje ',
    'support_footer_help' => 'Nurodykite, kas mato nuorodas į HSB-IT palaikymo informaciją ir naudotojo vadovą',
    'version_footer' => 'Versijos rodymas poraštėje ',
    'version_footer_help' => 'Nurodykite, kas mato HSB-IT versiją ir darinio (build) numerį.',
    ...
    'width_w' => 'p',
    'height_h' => 'a',
    'show_url_in_emails' => 'Nuoroda į HSB-IT el. laiškuose',
    'show_url_in_emails_help_text' => 'Atžymėkite šį langelį, jei nenorite, kad el. laiškų poraštėse būtų nuoroda į jūsų HSB-IT diegimą. Naudinga, jei dauguma naudotojų niekada nesijungia prie sistemos. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Bus bandoma ištrinti talpykloje saugomus brūkšninius kodus. Įprastai, tai yra naudojama, tik jei pasikeitė brūkšninio kodo nustatymai arba pasikeitė HSB-IT adresas. Brūkšniniai kodai bus sugeneruoti iš naujo, kai kitą kartą bus atidaryti.',
    ...
    'label2_2d_target_help' => 'Duomenys, kurie bus pateikti 2D brūkšniniame kode. Jie gali tiesiogiai nukreipti į turtą „HSB-IT“ programoje arba gali būti viena iš nesusietų lauko reikšmių. Jei naudosite aukščiau pateiktą prefiksą, jis bus pridėtas prieš šią reikšmę.',
    ...
    'help_default_will_use' => 'Atminkite, tam kad brūkšninis kodas būtų sėkmingai sugeneruotas, jo reikšmė turi atitikti pasirinkto brūkšninio kodo specifikacijas. Daugiau informacijos rasite <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">dokumentacijoje<i class="fa fa-external-link"></i></a>. ',
    'asset_id' => 'Turto ID',
    'data' => 'Duomenys',
    'default' => 'Numatytasis',
    'none' => 'Joks',
