...
return [
    ...
    'link_dark_color_help' => 'Vyberte barvu, která poskytne dostatečný kontrast pro lidi, kteří používají HSB-IT v tmavém režimu.',
    'link_light_color' => 'Barva odkazu pro světlý režim',
    'link_light_color_help' => 'Vyberte barvu, která poskytne dostatečný kontrast pro lidi, kteří používají HSB-IT ve světlém režimu.',
    ...
    'ldap_display_name_help' => 'Máte-li v LDAP/AD zvlášť pole displayName, namapujte jej zde a bude použit pro zobrazení uživatelů v HSB-IT.',
...
Tím zabráníte systému HSB-IT v pokusu načítat avatary z Gravataru nebo jiných externích zdrojů.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Pokud je zde uvedena adresa URL, uživatelé budou po odhlášení ze HSB-IT přesměrování na tuto URL. To je užitečné pro správné ukončení relací Authentication providera.',
    ...
    'show_images_in_email_help' => 'Zrušte zaškrtnutí této kolonky, pokud je instalace HSB-IT za VPN nebo uzavřenou sítí a uživatelé mimo síť nebudou moci do svých e-mailů načíst obrázky z této instalace.',
    ...
    'hsb_version' => 'Verze HSB-IT',
    'support_footer' => 'Odkazy v zápatí na podporu ',
    'support_footer_help' => 'Určete, kdo uvidí odkazy na HSB-IT podporu a uživatelskou příručku',
    'version_footer' => 'Verze v zápatí ',
    'version_footer_help' => 'Určete kdo uvidí verzi HSB-IT a číslo sestavení.',
    ...
    'width_w' => 'š',
    'height_h' => 'v',
    'show_url_in_emails' => 'Odkaz na HSB-IT v e-mailech',
    'show_url_in_emails_help_text' => 'Zrušte zaškrtnutí tohoto políčka, pokud nechcete odkazovat zpět na instalaci HSB-IT do vašich emailových patek. Užitečné, pokud se většina vašich uživatelů nikdy nepřihlásí.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Toto se pokusí odstranit čárové kódy v mezipaměti. Obvykle se používá v případě, kdy došlo ke změně nastavení čárového kódu nebo v případě, že se změnila URL adresa HSB-IT. Kódy budou vygenerovány znovu.',
    ...
    'label2_2d_target_help' => 'Data, která budou obsažena v 2D kódu. Může to odkazovat přímo na majetek ve HSB-IT nebo může být hodnotou jednoho z nepropojených polí. Pokud použijete prefix výše, bude předsazen před tuto hodnotu.',
