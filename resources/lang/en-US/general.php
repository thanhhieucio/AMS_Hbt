...
return [
    ...
    'importing' => 'Importing',
    'importing_help' => 'The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://docs.hsb.edu.vn/hsb-it/docs/importing" target="_new">sample CSVs in the documentation <i class="fa fa-external-link"></i></a>.',
    ...
    'webhook_test_msg' => 'Oh hai! It looks like your :app integration with HSB-IT is working!',
