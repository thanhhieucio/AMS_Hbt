...
return [
    ...
    'importing_help' => 'Die CSV sollte kommagetrennt sein und mit Kopfzeilen formatiert werden, die mit denen in den <a href="https://docs.hsb.edu.vn/hsb-it/docs/importing" target="_new"> Beispiel-CSVs in der Dokumentation <i class="fa fa-external-link"></i></a>übereinstimmen.',
    ...
    'webhook_test_msg' => 'Oh hi! Sieht so aus, als ob Deine :app Integration mit HSB-IT funktioniert!',
