...
return [
    ...
    'color_settings_help' => 'Diese Einstellungen werden im gesamten HSB-IT benutzt. Benutzer haben die Möglichkeit eine eigene Farbe für Links in ihrem Account zu setzten, damit die individuelle Lesbarkeit gegeben ist.',
    ...
    'link_dark_color_help' => 'Wähle eine kontrastreiche Farbe aus, die Personen benutzen wenn sie HSB-IT im dunklen Modus nutzen.',
    'link_light_color' => 'Link-Farbe im hellen Modus',
    'link_light_color_help' => 'Wähle eine kontrastreiche Farbe aus, die Personen benutzen wenn sie HSB-IT im hellen Modus nutzen.',
    ...
    'ldap_display_name_help' => 'Wenn Du ein separates Feld displayName in Deinem LDAP/AD hast, ordne es hier an und es wird zur Anzeige von Benutzern innerhalb von HSB-IT verwendet.',
    ...
    'load_remote_help_text' => 'Deaktiviere dieses Kästchen, wenn deine Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass HSB-IT versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus HSB-IT ausloggt. Dies ist nützlich, um die Benutzersitzung Deines Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help' => 'Deaktiviere dieses Kästchen, wenn sich Deine HSB-IT-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihren E-Mails laden können.',
    ...
    'support_footer_help' => 'Lege fest, wer die Links zu HSB-IT Support-Information und Benutzerhandbuch sieht',
    'version_footer' => 'Version in in der Fußzeile ',
    'version_footer_help' => 'Lege fest, wer die HSB-IT-Version- und Build-Nummer sieht.',
    ...
    'show_url_in_emails_help_text' => 'Deaktiviere dieses Kästchen, wenn du nicht auf deine HSB-IT-Installation in deinen E-Mail-Fußzeilen verlinken möchtest. Nützlich, wenn sich die meisten Nutzer nie anmelden. ',
    'text_pt' => 'pkt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Deine HSB-IT-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'label2_2d_target_help' => 'Die Daten, die im 2D Barcode enthalten sein werden. Dies kann direkt mit dem Asset in HSB-IT verbinden oder einer der nicht verknüpften Feldwerte sein. Wenn Du das Präfix oben verwendest, wird es diesem Wert vorangestellt.',
    ...
    'help_default_will_use' => 'Beachte, dass der Wert der Barcodes mit der jeweiligen Barcode-Spezifikation übereinstimmen muss, um erfolgreich generiert zu werden. Bitte lies <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">die Dokumentation <i class="fa fa-external-link"></i></a> für weitere Details. ',
    'asset_id' => 'Asset-ID',
    'data' => 'Daten',
    'default' => 'Standard',
    'none' => 'Nichts',
