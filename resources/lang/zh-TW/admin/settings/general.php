...
return [
    ...
    'color_settings_help' => '這些設定將套用於整個 HSB-IT。使用者可以透過編輯其帳號偏好設定來覆蓋連結顏色，以符合個人的可讀性需求。',
    'color_reset' => '重設為預設值',
    'confirm_purge' => '確認清除',
    ...
    'link_dark_color_help' => '選擇一個能為使用深色模式的 HSB-IT 使用者提供足夠對比度的顏色。',
    'link_light_color' => '淺色模式連結顏色',
    'link_light_color_help' => '選擇一個能為使用淺色模式的 HSB-IT 使用者提供足夠對比度的顏色。',
    ...
    'ldap_display_name_help' => '如果您的 LDAP/AD 中有單獨的 displayName 欄位，請在此處對映，它將用於在 HSB-IT 中顯示使用者名稱。',
    ...
    'license' => '軟體授權',
    'load_remote' => '載入遠端頭像',
    'load_remote_help_text' => '如果您的安裝無法從外部網際網路載入資源，請取消勾選此框。這將防止 HSB-IT 嘗試從 Gravatar 或其他外部來源載入頭像。',
    'login' => '登入嘗試',
    'login_attempt' => '登入嘗試',
    'login_ip' => 'IP 位址',
    'login_success' => '成功？',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此處提供了 URL，則在用戶登出 HSB-IT 後，用戶將被重定向到此 URL。這對於正確關閉身份驗證提供程序非常有用。',
    ...
    'show_images_in_email_help' => '如果您的HSB-IT安裝位於VPN或封閉網絡後面，並且外部網絡的用戶無法將通過此安裝提供的圖像加載到其電子郵件中，請取消選中此框。',
    'site_name' => '站台名稱',
    'integrations' => '整合',
    'slack' => 'Slack',
    ...
    'hsb_version' => 'HSB-IT 版本',
    'support_footer' => '支援頁尾連結',
    'support_footer_help' => '指定誰可以看到指向HSB-IT支持信息和用戶手冊的鏈接',
    'version_footer' => '頁尾版本 ',
    'version_footer_help' => '指定誰可以看到HSB-IT版本和內部版本號。',
    'system' => '系統資訊',
    'update' => '更新設定',
    'value' => '價值',
    'brand' => '企業識別',
    ...
    'width_w' => '寬',
    'height_h' => '高',
    'show_url_in_emails' => '鏈接到HSB-IT在電子郵件',
    'show_url_in_emails_help_text' => '如果您不希望鏈接回電子郵件頁腳中的HSB-IT安裝，請取消選中此框。如果您的大多數用戶從未登錄，則很有用',
    'text_pt' => '磅',
    ...
    'barcodes_help' => '這將嘗試刪除快取的條碼。這通常只在您的條碼設定已更改，或者您的 HSB-IT 網址已更改時使用。條碼將在下次存取時重新產生。',
    ...
    'label2_2d_target_help' => '二維條碼中將包含的資料。可以直接連結至 HSB-IT 中的資產，或選擇非連結的欄位值。若使用上方的前綴，該前綴將附加在此值之前。',
    ...
    'help_default_will_use' => '請注意，條碼的值必須符合各自的條碼規格才能成功產生。詳情請參閱<a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">說明文件 <i class="fa fa-external-link"></i></a>。',
    'asset_id' => '資產 ID',
    'data' => '資料',
    'default' => '開發人員選項',
    'none' => '無',
