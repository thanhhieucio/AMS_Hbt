...
return [
    ...
    'color_settings_help' => '这些设置将在 HSB-IT 全局生效。用户可在账户偏好中自定义链接颜色，以适应个人的阅读习惯。',
    'color_reset' => '重设为默认值',
    'confirm_purge' => '确认清除',
    ...
    'link_dark_color_help' => '选择一种颜色，确保为 HSB-IT 深色模式的用户提供足够的对比度。',
    'link_light_color' => '浅色模式链接颜色',
    'link_light_color_help' => '选择一种颜色，确保为 HSB-IT 浅色模式的用户提供足够的对比度。',
    ...
    'ldap_display_name_help' => '如果您在 LDAP/AD中有一个单独的 displayname 字段，在这里映射它，并且它将用于显示HSB-IT中的用户。',
    ...
    'license' => '软件许可证',
    'load_remote' => '加载远程头像',
    'load_remote_help_text' => '如果您的安装不能从外部网络加载脚本，请取消选中此项。 这将防止HSB-IT 尝试从 Gravatar 或其他外部来源加载头像。',
    'login' => '登录尝试',
    'login_attempt' => '登录尝试',
    'login_ip' => 'IP 地址',
    'login_success' => '成功？',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此处提供了URL，则在用户注销HSB-IT后，用户将被重定向到此URL。这对于正确关闭身份验证提供程序的用户会话非常有用。',
    ...
    'show_images_in_email_help' => '如果外部用户无法在邮件中通过你安装在VPN或内网的HSB-IT加载图片，请取消此复选框。',
    'site_name' => '站点名称',
    'integrations' => '集成',
    'slack' => 'Slack',
    ...
    'support_footer_help' => '指定谁可以看到指向HSB-IT支持信息和用户手册的链接',
    'version_footer' => '页脚中显示版本信息 ',
    'version_footer_help' => '指定谁可以看到HSB-IT版本和内部版本号。',
    'system' => '系统信息',
    'update' => '更新设置',
    'value' => '价值',
    'brand' => '品牌',
    ...
    'width_w' => '宽',
    'height_h' => '高',
    'show_url_in_emails' => '在电子邮件中显示HSB-IT链接',
    'show_url_in_emails_help_text' => '如果您不希望在电子邮件页脚中显示HSB-IT链接，请取消此框。如果您的大多数用户从未登录过系统，那么这项功能会很有作用。',
    'text_pt' => '磅',
    ...
    'barcodes_help' => '这将尝试删除缓存条形码。 这通常只有在您的条码设置已经更改或您的HSB-IT 链接已经更改时才使用。 下次访问时将重新生成条码。',
    ...
    'label2_2d_target_help' => '将包含在二维条码中的数据。 这可以直接连接到 HSB-IT 中的资产，或者可以是一个非关联的字段值。 如果您使用上面的前缀，它将被添加到这里。',
    ...
    'help_default_will_use' => '请注意，条形码的值必须符合各自的条形码规范才能成功生成。 欲了解更多详情，请参阅<a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">文档 <i class="fa fa-external-link"></i></a> ',
    'asset_id' => '资产ID',
    'data' => '数据',
    'default' => '默认',
    'none' => '无',
