...
return [
    ...
    'login' => '登录',
    'login_first_admin' => '请使用以下凭据登录新安装的 HSB-IT：',
    ...
    'serial' => '序列号',
    'hsb_webhook_test' => 'HSB-IT 集成测试',
    'hsb_webhook_summary' => 'HSB-IT 集成测试摘要',
    'supplier' => '供应商',
    'tag' => '标签',
    'test_email' => 'HSB-IT 测试邮件',
    'test_mail_text' => '这是一封 HSB-IT 资产管理系统的测试电子邮件，如果您收到，表示邮件通知正常运作 :)',
    ...
    'welcome_to' => '欢迎来到 :web！',
    'your_assets' => '查看您的资产',
    'your_credentials' => '您的 HSB-IT 登录凭据',
    'mail_sent' => '邮件发送成功！',
];
