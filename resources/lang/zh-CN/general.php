...
return [
    ...
    'importing' => '正在导入…',
    'importing_help' => 'CSV 文件应使用逗号作为分隔符，并且其表头格式需要与<a href="https://docs.hsb.edu.vn/hsb-it/docs/importing" target="_new">文档中的 CSV 示例文件<i class="fa fa-external-link"></i></a>中的表头保持一致。',
    ...
    'webhook_test_msg' => '哦哈！看起来您的 :app 与HSB-IT 的整合工作正常！',
