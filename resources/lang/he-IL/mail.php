...
return [
    ...
    'login' => 'התחברות',
    'login_first_admin' => 'היכנס למערכת ההתקנה החדשה של HSB-IT באמצעות פרטי הכניסה הבאים:',
    ...
    'supplier' => 'ספק',
    'tag' => 'תָג',
    'test_email' => 'מבחן דוא"ל מאת HSB-IT',
    'test_mail_text' => 'זהו מבחן מן Hsb- IT ניהול מערכת. אם יש לך את זה, הדואר עובד :)',
    ...
    'your_credentials' => 'שלך Hsb- IT אישורים',
