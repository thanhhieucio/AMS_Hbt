...
return [
    ...
    'ldap_activated_flag_help' => 'この値は、同期されたユーザーがHSB-ITにログインできるかどうかを決定するために使用されます。<strong>アイテムをチェックインまたはチェックアウトする機能には影響しません。</strong>また、<strong>値</strong>ではなく、AD/LDAP内の<strong>属性名</strong>である必要があります。<br><br>
...
これは認証プロバイダのセッションを正しく終了させる場合に便利です。',
    ...
    'show_images_in_email_help' => 'HSB-ITが閉鎖されたネットワーク内にある場合や、アクセスするためにVPNの利用が必要な場合はこのボックスのチェックを外してください。ネットワーク外のユーザは、配信されたメールにある画像を読み込むことはできません。',
    'site_name' => 'サイト名',
    'integrations' => 'サービス連携',
    'slack' => 'Slack',
    ...
    'hsb_version' => 'HSB-IT バージョン',
    'support_footer' => 'フッターのリンクをサポートします。 ',
    'support_footer_help' => 'HSB-ITサポート情報とユーザーマニュアルへのリンクを確認する',
    'version_footer' => 'フッターにバージョン情報を表示 ',
    'version_footer_help' => 'HSB-ITのバージョンとビルド番号を表示するか、管理者のみに表示させるかを設定できます。',
    'system' => 'システム情報',
    'update' => '設定を更新',
    'value' => '価値',
    'brand' => 'ブランディング',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'HSB-ITへのリンク',
    'show_url_in_emails_help_text' => '電子メールのフッターでHSB-ITのインストールにリンクしたくない場合は、このボックスのチェックを外してください。ほとんどのユーザーが決してログインしない場合に便利です。',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'キャッシュされたバーコードを削除しようとします。 これは通常、バーコード設定が変更された場合や、HSB-ITのURLが変更された場合にのみ使用されます。 バーコードは次にアクセスしたときに再生成されます。',
