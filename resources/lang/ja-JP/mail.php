...
return [
    ...
    'login' => 'ログイン',
    'login_first_admin' => '以下の新しいログイン情報を使用して、HSB-ITにログインします。',
    ...
    'serial' => 'シリアル',
    'hsb_webhook_test' => 'HSB-IT 統合テスト',
    'hsb_webhook_summary' => 'HSB-IT 統合テストの概要',
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'HSB-ITからのテストメール',
    'test_mail_text' => 'これはHSB-IT資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'HSB-IT クレデンシャル',
