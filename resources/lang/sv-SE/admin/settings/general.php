...
return [
    ...
    'load_remote_help_text' => 'Avmarkera denna ruta om din installation inte kan ladda skript från externa källor. Detta förhindrar att HSB-IT försöker ladda avatarer från Gravatar eller andra externa källor.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Om en URL tillhandahålls här kommer användarna att omdirigeras till den här webbadressen efter att användaren loggat ut från HSB-IT. Det här är användbart för att stänga användarsessionerna i din autentiseringsleverantör korrekt.',
    ...
    'show_images_in_email_help' => 'Avmarkera den här rutan om din HSB-IT-uppsättning ligger bakom ett VPN eller ett stängt nätverk och användare utanför nätverket kan inte ladda bilder som visas från den här installationen i sina e-postmeddelanden.',
    ...
    'support_footer_help' => 'Ange vem som kan se länkarna till HSB-IT-supportinfo och användarmanual',
    'version_footer' => 'Version i sidfot ',
    'version_footer_help' => 'Specificera vilka som kan se HSB-IT-version och versionsnummer.',
    ...
    'width_w' => 'b',
    'height_h' => 'h',
    'show_url_in_emails' => 'Länk till HSB-IT för e-postmeddelanden',
    'show_url_in_emails_help_text' => 'Avmarkera den här rutan om du inte vill länka tillbaka till din HSB-IT-installation i e-postfoten. Användbart om de flesta av dina användare aldrig loggar in. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Detta kommer att försöka ta bort cachade streckkoder. Detta skall normalt enbart användas om dina streckkodsinställningar har ändrats eller om din HSB-IT-URL har ändrats. Streckkoder kommer att återskapas när de används nästa gång.',
