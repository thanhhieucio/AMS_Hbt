...
return [
    ...
    'color_settings_help' => 'Ova podešavanja će biti korišćena kroz ceo HSB-IT. Korisnici mogu da prilagode boje linkova u podešavanjima njihovog naloga da bi ispunili individualni zahtevi za čitljivošću.',
    ...
    'link_dark_color_help' => 'Odaberite boju koja će pružiti dovoljan kontrast za ljude koji HSB-IT koriste u tamnom prikazu.',
    'link_light_color' => 'Boja veze za svetli prikaz',
    'link_light_color_help' => 'Odaberite boju koja će pružiti dovoljan kontrast za ljude koji HSB-IT koriste u svetlom prikazu.',
    ...
    'ldap_display_name_help' => 'Ako imate odvojeno displayName polje u vašem LDAP/AD-u, mapirajte ga ovde i biće korišćeno za prikazivanje korisnika u HSB-IT.',
    ...
    'load_remote_help_text' => 'Isključi ovo polje ako tvoja instalacija ne može da učita skripte sa spoljnog interneta. Ovo će sprečiti HSB-IT od pokušaja da učita slike sa Gravatara ili drugih spoljnih izvora.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako se ovde navede url, korisnici će biti preusmereni na ovu URL adresu nakon što se korisnik odjavi sa HSB-IT-a. Ovo je korisno za pravilno zatvaranje korisničkih sesija vašeg dobavljača autentikacije.',
    ...
    'show_images_in_email_help' => 'Poništite izbor u ovom polju za potvrdu ako je vaša HSB-IT instalacija iza VPN-a ili zatvorene mreže i korisnici van mreže neće moći da učitavaju slike koje se serviraju iz ove instalacije u svoje imejlove.',
    ...
    'hsb_version' => 'HSB-IT verzija',
    'support_footer' => 'Podška za linkove u podnožju ',
    'support_footer_help' => 'Navedite ko vidi veze do informacija o podršci za HSB-IT i korisničkog priručnika',
    'version_footer' => 'Verzija u podnožju ',
    'version_footer_help' => 'Navedite ko vidi verziju HSB-IT-a i broj verzije.',
    ...
    'width_w' => 'š',
    'height_h' => 'v',
    'show_url_in_emails' => 'Link ka HSB-IT in emailovima',
    'show_url_in_emails_help_text' => 'Poništite izbor u ovom polju za potvrdu ako ne želite da se vratite na svoju HSB-IT instalaciju u podnožju e-pošte. Korisno ako se većina vaših korisnika nikada ne prijavi. ',
    'text_pt' => 'pt',
    ...
    'label2_2d_target_help' => 'Podatak koji će biti sadržan u 2D barkodu. Ovo može biti direktna veza do imovine u HSB-IT ili može biti jedna od vrednosti polja koja nizu u obliku veze. Ako koristite prefiks iznad, biće dodat na početak ove vrednosti.',
    ...
    'help_default_will_use' => 'Vodite računa da vrednost barkodova mora da se usaglasi sa odgovarajućom specifikacijom da bi se uspešno generisao. Pogledajte <a href="https://docs.hsb.edu.vn/hsb-it/docs/barcodes">dokumentaciju<i class="fa fa-external-link"></i></a> za više detalja. ',
    'asset_id' => 'ID imovine',
    'data' => 'Podatak',
