...
return [
    ...
    'show_images_in_email_help' => 'Poista tämä valinta, jos HSB-IT asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'hsb_version' => 'HSB-IT versio',
    'support_footer' => 'Tuki-alatunnisteen linkit ',
    'support_footer_help' => 'Määrittele, kuka voi nähdä linkit HSB-IT tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer' => 'Versio alatunnisteessa ',
    'version_footer_help' => 'Määrittele, kuka näkee HSB-IT järjestelmän version ja käännöksen numeron.',
    ...
    'width_w' => 'l',
    'height_h' => 'k',
    'show_url_in_emails' => 'Linkki HSB-IT: hen sähköposteissa',
    'show_url_in_emails_help_text' => 'Poista tämä valintaruutu, jos et halua linkata takaisin HSB-IT-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Tämä yrittää poistaa välimuistissa olevat viivakoodit. Tätä käytetään yleensä vain, jos viivakoodisi asetukset ovat muuttuneet, tai jos HSB-IT URL on muuttunut. Viivakoodit luodaan uudelleen, kun niitä käytetään seuraavaksi.',
