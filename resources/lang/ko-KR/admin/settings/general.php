...
return [
    ...
    'login_remote_user_custom_logout_url_help' => '채워진 사용자는 HSBIT 세션이 종료된 후에 이 URL로 리디렉션됩니다. 이 기능은 인증 제공자의 사용자 세션을 정확하게 닫는데 유용합니다.',
    ...
    'show_images_in_email_help' => 'HSB-IT 설치가 VPN 또는 폐쇄 형 네트워크 하에 있고 네트워크 외부 사용자가 이 설치에서 제공된 이미지를 이메일에 불러올수 없는 경우 이 상자의 선택을 해제하세요.',
    'site_name' => '사이트 명',
    ...
    'hsb_version' => 'HSB-IT 버전',
    'support_footer' => '꼬리말 링크 지원',
    'support_footer_help' => 'HSB-IT 지원 정보 및 사용자 매뉴얼 보기 권한 설정',
    'version_footer' => '바닥글에 버전 ',
    'version_footer_help' => 'HSB-IT 버전과 빌드 번호를 볼 수 있는 사용자를 지정합니다.',
    'system' => '시스템 정보',
    'update' => '갱신 설정',
    'value' => '가치',
    'brand' => '브랜딩',
    ...
    'width_w' => '넓이',
    'height_h' => '높이',
    'show_url_in_emails' => 'HSB-IT에 이메일로 링크',
    'show_url_in_emails_help_text' => '전자 메일 바닥 글에 HSB-IT 설치를 다시 연결하지 않으려면이 상자를 선택 취소하십시오. 대부분의 사용자가 로그인하지 않는 경우 유용합니다.',
    'text_pt' => 'pt',
