...
return [
    ...
    'login' => '로그인',
    'login_first_admin' => '아래의 자격 증명을 사용하여 새 HSB-IT 설치본에 로그인 하세요:',
    ...
    'supplier' => '공급자',
    'tag' => '태그',
    'test_email' => 'HSB-IT에서 테스트 이메일',
    'test_mail_text' => '이것은 HSB-IT 자산 관리 시스템에서 온 테스트 입니다. 이 것을 받았다면, 메일은 동작중입니다 :)',
    ...
    'your_assets' => '자산 확인',
    'your_credentials' => '당신의 HSB-IT 인증들',
