    ...
    <div class="list clearfix">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="admin box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.portal.index') }}" class="settings_button">
                  <x-icon type="dashboard" class="fa-4x"/>
                  <br><br>
                  <span class="name">{{ trans('admin/settings/general.portal_title_short') }}</span>
                  <span class="keywords" aria-hidden="true" style="display:none">{{ trans('admin/settings/general.keywords.portal') }}</span>
                </a>
              </h5>
              <p class="index-block">{{ trans('admin/settings/general.portal_help') }}</p>
            </div>
          </div>
        </div>
