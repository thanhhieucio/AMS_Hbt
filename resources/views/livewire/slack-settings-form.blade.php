                    ...
                    <div class="col-md-12" style="border-top: 0px;">
                        ...
                        @if($webhook_selected != 'microsoft' && $webhook_selected != 'google')
                            <div class="form-group{{ $errors->has('webhook_botname') ? ' error' : '' }}">
                                ...
                                <div class="col-md-9">
                                        <input type="text" wire:model.change.live="webhook_botname" class='form-control' placeholder="Hsb-Bot" {{ old('webhook_botname', $webhook_botname)}}{{ Helper::isDemoMode() ? ' disabled' : ''}}>
