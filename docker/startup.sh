...
if [ -f /var/lib/hsbit/ssl/hsbit-ssl.crt -a -f /var/lib/hsbit/ssl/hsbit-ssl.key ]
then
  a2enmod ssl
else
  a2dismod ssl
...
# https://github.com/thanhhieucio/HSB-IT/blob/master/app/Console/Commands/RestoreFromBackup.php#L232
for dir in \
